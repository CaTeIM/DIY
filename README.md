...
| **[🖧 RustDesk Server self-hosted (hbbs/hbbr)](./docs/rustdesk-server.md)**               | Migra o RustDesk Server para a VPS Oracle (Docker, ARM) preservando a mesma Key, para controlar todas as máquinas com o cliente nativo. Servidor de ID/relay próprio, sem a nuvem pública.                    | `RustDesk`, `Docker`, `hbbs/hbbr`, `Oracle Cloud`, `ARM`                    |
